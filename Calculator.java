...
//set Co-ordinates for Operator Buttons
    ...
    public static void main(String []args)
    {
        new Calculator("Calculator - Scientific-Calculator");
    }
}
...
class MyOperatorButton extends Button implements ActionListener
{
    ...
    public String OperatorCalculate(String opText, double temp)
    {
...
// process = button pressed
        ...
        return Calculator.getFormattedText(temp);
    }
    public void actionPerformed(ActionEvent ev)
    {
        ...
        String result = OperatorCalculate(opText,temp);

        cl.displayLabel.setText(result);
//cl.number=temp;
    }//actionPerformed
}//class
